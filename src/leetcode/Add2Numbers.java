...
public class Add2Numbers
{
    ...
    public static void main(final String[] args)
    {
        ...
        /*
         * , l2_04 = new ListNode(9, l2_05),
         * l2_03 = new ListNode(9, l2_04), l2_02 = new ListNode(9, l2_03), l2_01 = new ListNode(9, l2_02);
         */
    ...
    public static ListNode getSum(ListNode l1, ListNode l2)
    {
        ...
        {
            final int l1val = l1 == null ? 0
                                         : l1.val;
            final int l2val = l2 == null ? 0
                                         : l2.val;
